          ...
          <div className="col-md-6 px-4">
            <div className="d-flex flex-row align-items-center">
              ...
              <div className="pokemon-list-box d-flex flex-row w-full">
                <img src={val.avatar} height={100} width={100} className="mr-2"/>
                <div className="d-flex flex-column justify-content-center">
                  <h4> {val.nickname}</h4>
                  <div>{val.name}</div>
                </div>
                <div className="d-flex flex-column justify-content-center ml-auto pr-5">
                  <RemoveCircleIcon fontSize={'25px'} htmlColor={'#541a1c'} className="cursor-pointer" onClick={()=>onReleasePokemonClick(id)}/>
                </div>
              </div>
            </div>
          </div>
